...
1. Use `mine` to gather 5 oak_log or spruce_log (whatever is nearby).
...
8. Use `mine` to gather 20 cobblestone (needs wooden pickaxe equipped).
...
- Always use `mine` to gather blocks — it pathfinds to the nearest one automatically.
